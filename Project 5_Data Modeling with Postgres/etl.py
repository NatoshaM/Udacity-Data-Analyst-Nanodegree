...
def process_song_file(cur, filepath):
    """
        Used to read the file in filepath to get song/artist data and
        populate tables 
...
def process_log_file(cur, filepath):
    """ 
    Used to read files to get user/time information and populate tables
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
   ...
   reads file names in the filepath.
...
def main():
    """
    connect to the database and provides cursor.
